...
const Contact = {
  ...
  async create(data, userId) {
    // portal_contact_no is omitted — auto-generated by DB sequence (PCNT-XXXX)
    const query = `
    ...
    const values = [
      ...
      data.role || data.partnerType || null,          // $10
      ...
      data.department || null,                        // $22
      data.faxNo || null,                             // $23
      data.homePage || null,                          // $24
      data.syncStatus || "Pending",                   // $25
      data.lastSyncedDateTime || null,                // $26
      userId || null,                                 // $27
    ];
  ...
  async update(id, data) {
    // portal_contact_no is excluded — auto-generated, never updated
    const query = `
      UPDATE contacts SET
