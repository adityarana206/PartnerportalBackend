  ...
  try {
    ...
    try {
      const bcPayload = {
        ...
        expectedDeliveryDate: req.body.expectedDeliveryDate  ? req.body.expectedDeliveryDate.split('T')[0] : null,
        actualDeliveryDate:   req.body.actualDeliveryDate    ? req.body.actualDeliveryDate.split('T')[0] : null,
        deliveryDate:         req.body.actualDeliveryDate    ? req.body.actualDeliveryDate.split('T')[0] : null,
        status:               "Inserted",
